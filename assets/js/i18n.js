  ...
  const translations = {
    id: {
      ...
      hero: {
        ...
        typed_items: "Web Developer, IT Support, Network Engineer, Mahasiswa Informatika",
      ...
      experience: {
        ...
        exp2_pt2: "Mahasiswa semester 8, berorientasi menyelesaikan studi dengan predikat memuaskan.",
      ...
      projects: {
        ...
        subtitle: "Proyek pilihan &mdash; dari aplikasi web, bot AI, hingga integrasi sistem nyata.",
        p1_tag: "Magang",
        p1_title: "Sistem Informasi UMKM & Pariwisata Dinas Pariwisata Tangsel",
        p1_desc: "Dibangun untuk Dinas Pariwisata Kota Tangerang Selatan saat magang. Platform web untuk pengajuan izin usaha UMKM serta sistem informasi pariwisata yang menampilkan destinasi menarik di kawasan Tangsel.",
        p2_tag: "Web App",
        p2_title: "Karyawanku — Sistem Manajemen Karyawan",
        p2_desc: "Platform manajemen internal perusahaan lengkap dengan modul penggajian (payroll), absensi, permohonan cuti, dan data karyawan. Dilengkapi antarmuka intuitif dan dashboard admin.",
        p3_tag: "Bot Telegram",
        p3_title: "VansGPT — AI Telegram Bot",
        p3_desc: "Bot Telegram interaktif yang terintegrasi dengan API model bahasa kecerdasan buatan (AI). Mendukung percakapan kontekstual, respon streaming cepat, dan perintah kustom.",
      },
      github: {
    ...
    en: {
      ...
      hero: {
        ...
        typed_items: "Web Developer, IT Support, Network Engineer, Informatics Student",
      ...
      about: {
        ...
        subtitle: "An informatics student passionate about networking and IT support — building things that work, learning the ones that don&rsquo;t.",
        headline_pre: "Informatics student focused on ",
        headline_accent: "web programming",
        desc: "8th-semester Information Technology student at <strong>Bina Sarana Informatika University</strong> (GPA <strong>3.74</strong>). Passionate about web development &mdash; building things with Laravel, Node.js, and modern web technologies. I also have hands-on experience in IT Support, Network Engineering and Cyber Security, with skills in Python, PHP, and Mikrotik. Comfortable across the stack, ready to make positive contributions in a dynamic technology environment.",
        info_name: "Name",
        info_city: "City",
        info_city_val: "Bogor, Indonesia",
      ...
      experience: {
        ...
        exp2_pt2: "8th-semester student, on track to complete the program with distinction.",
        exp3_period: "2019 — 2022",
      ...
      projects: {
        ...
        title_accent: "built.",
        subtitle: "Selected work &mdash; from web platforms to networking labs and live GitHub activity.",
        p1_tag: "Internship",
        p1_title: "Sistem Informasi UMKM & Pariwisata Dinas Pariwisata Tangsel",
        p1_desc: "Built for Dinas Pariwisata Kota Tangerang Selatan during my internship. A web platform for UMKM business submissions and a tourism information system featuring destinations across the region.",
        p2_tag: "Web App",
        p2_title: "Karyawanku &mdash; Employee Management System",
        p2_desc: "A full management platform for companies with payroll, attendance, leave-request and complete employee modules. Built with an intuitive interface and comprehensive admin features.",
        p3_tag: "Telegram Bot",
        p3_title: "VansGPT &mdash; AI Telegram Bot",
        p3_desc: "An intelligent Telegram bot integrated with an AI language model API. Features context-aware conversation handling, rapid response streaming, and custom command configurations.",
      },
      github: {
